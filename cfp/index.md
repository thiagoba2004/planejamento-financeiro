...
Área central para acompanhar a estrutura vigente da certificação CFP® e os materiais oficiais usados pelo Projeto.

## Exame em 2026

Na verificação de 21/09/2026:
- a estrutura vigente está organizada em **oito módulos**;
- o **Módulo II é Gestão Financeira**;
- o **54º Exame CFP®** está indicado pela Planejar para **18/10/2026**.

Dados de edição de prova são perecíveis. Após a realização do exame, a data deve ser tratada como informação histórica e a edição vigente precisa ser reconfirmada.

## Materiais oficiais centrais
...
O conteúdo público deve distinguir:
...
O Site Planejamento Financeiro é um **projeto independente**. Não é página oficial da Planejar nem da FPSB. Em caso de divergência, prevalecem os materiais oficiais vigentes das instituições responsáveis.

**Última verificação das informações do exame:** 21/09/2026.
